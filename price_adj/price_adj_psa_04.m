function [stMachinePriceInfo] = price_adj_psa_04(stBerthJobInfo, stMachineUsageInfo, stMachinePriceInfo)
...
%alpha_input = stBerthJobInfo.stPriceAjustment.fAlpha
%fNumeratorAlphaByCapac
%fDenominatorAlphaByCapac
%fNumeratorAlphaByUsage
%fDenominatorAlphaByUsage
%stMachinePriceInfo.astMachinePrice(1).fPricePerFrame
%stMachinePriceInfo.astMachinePrice(2).fPricePerFrame

alpha = stBerthJobInfo.stPriceAjustment.fAlpha * sqrt(fNumeratorAlphaByCapac/fDenominatorAlphaByCapac * fNumeratorAlphaByUsage/fDenominatorAlphaByUsage);
...
stMachinePriceInfo.s_r = stMachinePriceInfo.s_r * ones(nTotalMachine, 1);
%% output structure
