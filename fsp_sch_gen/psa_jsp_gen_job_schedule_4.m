function [stContainerDischargeJobSequence, container_jsp_discha_schedule, stContainerLoadJobSequence, container_jsp_load_schedule, container_jsp_schedule] = psa_jsp_gen_job_schedule_4(stQuayCraneJobList)
...
%stPrimeMoverDoingJobSet.aTimeSetPreviousJobCompleted
%stYardCraneDoingJobSet.aTimeSetPreviousJobCompleted
%MaxVirtualPrimeMover
%MaxVirtualYardCrane
%%%%%%% Generate Discharging Schedule
for ii = 1:1:TotalContainer_Discharge
    if ii <= MaxVirtualPrimeMover & ii <= MaxVirtualYardCrane
        ...
        if ii == 1
            stContainerDischargeJobSequence(ii).StartTime = stQuayCraneJobList.iReleaseTimeSlotGlobal; % 20080323
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% [MaxVirtualYardCrane + 1, MaxVirtualPrimeMover]
    elseif ii <= MaxVirtualPrimeMover & ii > MaxVirtualYardCrane
        if stContainerDischargeJobSequence(ii).PM_Id == 0
            stContainerDischargeJobSequence(ii).iPM_Id = ii;
            minTimeCompletePM = 0;
        elseif stContainerDischargeJobSequence(ii).PM_Id <= MaxVirtualPrimeMover
        ...
        if stContainerDischargeJobSequence(ii).YC_Id == 0
            ...
            index_min_YC = 1;
            for jj = 2:1:MaxVirtualYardCrane
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% [ MaxVirtualPrimeMover + 1, MaxVirtualYardCrane]
    elseif ii > MaxVirtualPrimeMover & ii <= MaxVirtualYardCrane
        if stContainerDischargeJobSequence(ii).YC_Id == 0
            stContainerDischargeJobSequence(ii).iYC_Id = ii;
            minTimeCompleteYC = 0;
        ...
        if stContainerDischargeJobSequence(ii).PM_Id == 0
            ...
            index_min_PM = 1;
            for jj = 2:1:MaxVirtualPrimeMover
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% [max(MaxVirtualPrimeMover + 1,MaxVirtualYardCrane + 1), N]
    else
        if stContainerDischargeJobSequence(ii).PM_Id == 0
            minTimeCompletePM = stPrimeMoverDoingJobSet.aTimeSetPreviousJobCompleted(1);
            iPM_Id_minTime = stPrimeMoverDoingJobSet.iPM_Id(1);
...
for ii = 1:1:TotalContainer_Load
    ...
    if ii == 1
        if TotalContainer_Discharge >= 1
            ...
            tEstimaFromPrevJobStartTime = stQuayCraneJobList.iReleaseTimeSlotGlobal; % 20080323;
        end
    else
        tEstimaFromPrevJobStartTime = ...
